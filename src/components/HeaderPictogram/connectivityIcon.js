...
export default class ConnectivityIcon extends React.Component {
	...
	connectIcon = () => {
		switch(this.state.quality){
			case 0:
				return <SignalWifiOff sx={{...iconStyle, color:this.color()}} />
			case 1:
				return <SignalWifi4Bar sx={{...iconStyle, color:this.color()}} />
			case 2:
				return <SignalWifi3Bar sx={{...iconStyle, color:this.color()}} />
			case 3:
				return <SignalWifi2Bar sx={{...iconStyle, color:this.color()}} />
			case 4:
				return <SignalWifi1Bar sx={{...iconStyle, color:this.color()}} />
			case 5:
				return <SignalWifi4Bar sx={{...iconStyle, color:this.color()}} />
			case 6:
				return <SignalWifiStatusbarConnectedNoInternet4 sx={{...iconStyle, color:this.color()}} />
			default:
				return <SignalWifiOff sx={{...iconStyle, color:this.color()}} />
		}
	}
