...
// import image_cedri from './logo_b.png';
import image_ipb from './IPB-Cor@2x.png';
...
const AuthBackground = () => {
    ...
    return (
        <Box sx={{ position: 'absolute', filter: 'blur(18px)', zIndex: -1, bottom: 0 }}>
            {/* <img width="100%" height="calc(100vh - 175px)" src={image_cedri} /> */}
            <img width="100%" height="calc(100vh - 175px)" src={image_ipb} />
                {/* <path
